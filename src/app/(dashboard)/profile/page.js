...
import { User, Mail, Shield, Calendar, MapPin, Phone, Camera, LogOut, Edit3 } from 'lucide-react';
      ...
      <div className='-mt-24 px-10 relative z-10'>
        <div className='flex flex-col md:flex-row md:items-end justify-between gap-8'>
          ...
          <div className='flex items-center gap-3'>
            <Button className='bg-white/5 hover:bg-white/10 text-white font-bold h-12 px-6 rounded-2xl border border-white/5 transition-all'>
              <Edit3 size={18} className='mr-2' /> Edit Profile
            </Button>
            <SignOutButton>
              <Button
                variant='destructive'
                className='bg-rose-500 hover:bg-rose-600 text-white font-bold h-12 px-6 rounded-2xl shadow-lg shadow-rose-500/20 transition-all'
              >
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-8 px-2'>
        <Card className='md:col-span-2 glass-card border-none p-10 space-y-10'>
          <div className='space-y-8'>
            <h3 className='text-sm font-black text-white uppercase tracking-[0.2em] opacity-50 flex items-center gap-3'>
          ...
          <div className='p-8 bg-primary/5 rounded-[2rem] border border-primary/20 relative overflow-hidden'>
            <div className='flex items-start gap-6 relative z-10'>
              ...
              <div>
                ...
                <p className='text-slate-400 text-xs font-medium leading-relaxed max-w-[340px]'>
        ...
        <Card className='glass-card border-none p-8 space-y-8'>
          <h3 className='text-sm font-black text-white uppercase tracking-widest opacity-50 text-center'>
            Activity Pulse
          </h3>
          ...
          <div className='space-y-6'>
            {[
              ...
              >
                <p className='text-[9px] font-extrabold text-slate-600 uppercase tracking-[0.2em] mb-2'>
                  {stat.label}
                </p>
